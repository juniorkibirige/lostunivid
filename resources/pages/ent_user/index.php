...
<head>
    ...
    <meta name="description" content="The one stop point to find and announce all lost University ID's">
    <meta name="author" content="Junior Lawrence Kibirige">
    <link rel="icon" href="/svg/icon.svg" type="image/svg+xml">

    <title>Lost University ID Portal : Enterprises</title>
...
<body>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-dark" style="background-color: burlywood!important">
        <div class="col-md-5 p-lg-5 mx-auto my-5">
            ...
            <p class="lead font-weight-normal">The one stop point to find and announce all lost University ID's Service for Universities</p>
