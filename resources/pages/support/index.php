...
<head>
    ...
    <meta name="description" content="The one stop point to find support and faqs/frequently asked questions on Lost University ID's Portal">
    <meta name="author" content="Junior Lawrence Kibirige">
    <link rel="icon" href="/svg/icon.svg" type="image/svg+xml">

    <title>Lost University ID Portal : Support</title>
...
<body>
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-dark" style="background-color: burlywood!important">
        <div class="col-md-5 p-lg-5 mx-auto my-5">
            <h1 class="display-4 font-weight-normal">Lost University ID Support Portal</h1>
            <p class="lead font-weight-normal">For all Frequently Asked Questions and other queries</br>You are in the right place</p>
            <p><i><small>Unfortunately our services are under development</small></i></p>
