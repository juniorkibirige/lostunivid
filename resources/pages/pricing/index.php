...
<head>
    ...
    <meta name="description" content="The pricing of the Pro services on the Lost University ID Portal">
    <meta name="author" content="Junior Lawrence Kibirige">
    <link rel="icon" href="/svg/icon.svg" type="image/svg+xml">

    <title>Lost University ID Portal : Pricing</title>
...
<body>
    ...
    <div class="pull-down text-center bg-light sticky-top" style="position: fixed; z-index: 1020; top: 47.5px; width: 100%; opacity: 0.4; cursor: pointer">
        <span class="fa fa-angle-down" style="color: black"></span>
    </div>

    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-dark" style="color: aliceblue">
        <div class="col-md-5 p-lg-5 mx-auto my-5">
            ...
            <p><i><small>Currently our services are free</small></i></p>
